...
export class ArticleBonEntreeService {
  ...
  public ajouterArticleBonEntree(formData: FormData): Observable<ArticleBonEntree> {
    return this.httpClient.post<ArticleBonEntree>(`${this.urlServeur}/AjouterArticleBonEntree`, formData);
  }

  public modifierArticleBonEntree(formData: FormData): Observable<ArticleBonEntree> {
    return this.httpClient.post<ArticleBonEntree>(`${this.urlServeur}/ModifierArticleBonEntree`, formData);
  }

  public supprimerArticleBonEntree(identifiantBECodeArticleBonEntree: string): Observable<CustomHttpRespone> {
    return this.httpClient.delete<CustomHttpRespone>(`${this.urlServeur}/SupprimerArticleBonEntreeByArticleBonEntreeId/${identifiantBECodeArticleBonEntree}`);
  }
  ...
  public createArticleBonEntreeFormData(articleBonEntree: ArticleBonEntree): FormData {
    ...
    formData.append('identifiantBE', JSON.stringify(articleBonEntree.identifiantBE));
    formData.append('codeArticleBonEntree', articleBonEntree.codeArticleBonEntree.toString());
    ...
    formData.append('dateEnregistrement', JSON.stringify(articleBonEntree.dateEnregistrement));
    formData.append('codeTypeObjet', JSON.stringify(articleBonEntree.codeTypeObjet));
    formData.append('matriculeAgent', JSON.stringify(articleBonEntree.matriculeAgent));
